...
subroutine stif03(ndim,ndf,nen,nst,icn,d,ul,xl, feint,keint)
!
!----------------------------------------------------------------------------------------
!
...
do ig = 1, nip
  ...
  call shp2d(sg(1,ig),sg(2,ig),xl,.false., shps,xsj)
  ! compute the volume element
  dvol = xsj*sg(3,ig)
  ! get the displacement gradient
  call kine03(ndim,ndf,nen,shps,ul, dudx)
  ! get the Cauchy stress sig and spatial tagent modulus c at ig
  call modl03(ndim,d,dudx, sig,aa)
...
subroutine kine03(ndim,ndf,nen,shps,ul, gradu)
!
!----------------------------------------------------------------------------------------
!
!  kine03: Compute the deformation gradient F
!  
!  INPUT:
...
return
end subroutine kine03

subroutine modl03(ndim,d,dudx, sig,aa)
!
!----------------------------------------------------------------------------------------
!
...
return
end subroutine modl03


subroutine stre03(ndim,ndf,nen,nst,icn,d,ul,xl, lpm,stp)
!
!----------------------------------------------------------------------------------------
!
...
do ig = 1, nip
  ...
  call kine03(ndim,ndf,nen,shps,ul, F)
  ! get the Cauchy stress sig and spatial tagent modulus c at ig
  call modl03(ndim,d,F, sig,aa)
...
return
end subroutine stre03


subroutine stifcont03(ndim,ndf,nen,nip,icn,jcn, fecontij,kecontij)

use math
use config, only : vcntp, xr, disp
implicit none
